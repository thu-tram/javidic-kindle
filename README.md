...
This is a Japanese-Vietnamese dictionary based on the
Javidic database (converted from Yomichan format) for
...
The dictionary will _not_ work well on _Kindle Fire_ or _Kindle Android App_,
